#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# run_deepseek_r1_distill_qwen1.5b_first_think_roc_n32_pass4.sh
#
# GRPO-RoC + First-Think Pass@4 Reward.
#
# Rollout: 32 responses per prompt (n=32).
# RoC selection: keep 16 per prompt (target_n=16), ranked by pass_rate desc.
...
#   train_batch_size=112  →  112 × 16 = 1792 samples after RoC
#   ppo_mini_batch_size=56  →  56 × 16 = 896 global mini-batch  →  128 per GPU
# ---------------------------------------------------------------------------
...
EXPERIMENT_NAME="deepseek_r1_grpo_first_think_roc_n32_pass4"
