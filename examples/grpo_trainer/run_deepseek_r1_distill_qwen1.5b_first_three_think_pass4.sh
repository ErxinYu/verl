#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# run_deepseek_r1_distill_qwen1.5b_first_three_think_pass4.sh
#
# First-Three-Think Pass@4 Reward:
#   Same as first_think_pass4 but truncates the CoT at the 3rd backtracking
#   word instead of the 1st.  Lets the model use three thinking segments
#   before the vllm server probes whether the prefix is answer-sufficient.
#
#   Reward = binary_acc + 0.5 * (correct_completions / 4)
# ---------------------------------------------------------------------------
...
REWARD_PATH="${SCRIPT_DIR}/first_three_think_pass4_reward.py"

MODEL="deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B"
EXPERIMENT_NAME="1_5B_grpo_3think_0504"
...
"${PYTHON}" -m verl.trainer.main_ppo \
    ...
    ++reward.custom_reward_function.reward_kwargs.n_thinks=3 \
